...
public class CircularGradientTexture3D extends Texture3D {
	
	/*
	 * A gradient texture in two dimensions
	 */
	 ...
	 * Constructor
	 * *********************************************************************************************/
	public CircularGradientTexture3D()
	{
	...
	public CircularGradientTexture3D(Color firstColor, Color secondColor)
	{
	...
	public CircularGradientTexture3D(Color firstColor, Color secondColor, double weight)
	{
		this.firstColor = firstColor;
		this.secondColor = secondColor;
		this.weight = weight;
