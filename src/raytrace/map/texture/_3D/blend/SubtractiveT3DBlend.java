...
public class SubtractiveT3DBlend extends Texture3D {
	
	/*
	 * A texture blend for subtracting two textures
	 */
	 ...
	 * Constructor
	 * *********************************************************************************************/
	public SubtractiveT3DBlend()
	{
		this.firstTexture = null;
		this.secondTexture = null;
	}
	
	public SubtractiveT3DBlend(Texture3D firstTexture, Texture3D secondTexture)
	{
	...
	public Color evaluate(Double x, Double y, Double z)
	{
		...
		return firstColor.subtract3(secondColor);
	}
